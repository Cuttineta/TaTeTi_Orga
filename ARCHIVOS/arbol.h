...
/**
 Elimina el nodo N de A. El elemento almacenado en el arbol es eliminado mediante la funci�n fEliminar parametrizada.
 Si N es la raiz de A, y tiene un solo hijo, este pasa a ser la nueva raiz del �rbol.
